return {
    {
        ...
        config = function()
            ...
            vim.keymap.set(
                "n",
                "<leader>ef",
                "<cmd>Neotree float source=filesystem<CR>"
            )
            vim.keymap.set(
                "n",
                "<leader>eb",
                "<cmd>Neotree float source=buffers<CR>"
            )
            vim.keymap.set(
                "n",
                "<leader>es",
                "<cmd>Neotree float source=document_symbols<CR>"
            )
            vim.keymap.set(
                "n",
                "<leader>eg",
                "<cmd>Neotree float source=git_status<CR>"
            )
