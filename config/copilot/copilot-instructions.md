...
- Provide "Commit changes" as an option if you have made code edits, to trigger a commit workflow.
- Always provide a "Perform code review" option to trigger a final review.

### 4.1. Code Review

Run `code review` only when the user explicitly requests it.
