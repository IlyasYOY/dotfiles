...
Delegate work to specialized subagents instead of doing everything in the main context. The main context is for orchestration and reasoning — not execution.
