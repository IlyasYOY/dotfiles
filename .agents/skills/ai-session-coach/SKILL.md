...
```bash
python3 /Users/ilyasyoy/Projects/IlyasYOY/notes-wiki/.agents/skills/ai-session-coach/scripts/collect_sessions.py \
    --unarchived \
...
```bash
python3 /Users/ilyasyoy/Projects/IlyasYOY/notes-wiki/.agents/skills/ai-session-coach/scripts/archive_sessions.py \
